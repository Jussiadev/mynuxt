...
$('.select_list_radio').on('click', function(){
    ...
    document.cookie = "city=" + escape(current) + ";";
});

//Функция для получения значения куки
//возвращает значение, которое обработано функцией unescape() для перекодирования
// к нормальному символьному виду. (Если куки не найдено, возвращается значение null.)
